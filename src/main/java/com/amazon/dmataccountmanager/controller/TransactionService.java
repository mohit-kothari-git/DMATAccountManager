...
public class TransactionService {
	...
	public void buyShares() {
		System.out.println("Enter 0 to view all shares available or Share_id to be purshared");
		...
		if(id == 0) {
			...
			System.out.println("Enter Share_id to be purshared");
			id = scanner.nextInt();
		}else {
	...
	public void viewtransaction() {
		System.out.println("~~~~~~~~~~~~~~~~~~~~~~~Transacction View Panel~~~~~~~~~~~~~~~~~~~~");
		System.out.println("~~~~~~~~~Transaction Menu~~~~~~~~~");
		System.out.println("1: Transactions between Date Rage");
